...
// Rename within one filesystem. With replaceExisting this is the primitive for
// publishing a fully flushed temporary file atomically.
...
// Persist directory-entry updates after an atomic rename on POSIX. Windows
// MoveFileExW with MOVEFILE_WRITE_THROUGH already provides the matching fence.
