...
[Matching native 1.2.10 Windows and Linux packages](https://github.com/MiniLangProject/MiniLangCompilerML/releases/tag/v1.2.10)
...
`MiniLang Compiler 1.2.10`. `python mlc_win64.py --help` prints the full option
list.
