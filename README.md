...
[Matching native 1.2.9 Windows and Linux packages](https://github.com/MiniLangProject/MiniLangCompilerML/releases/tag/v1.2.9)
...
`MiniLang Compiler 1.2.9`. `python mlc_win64.py --help` prints the full option
list.
