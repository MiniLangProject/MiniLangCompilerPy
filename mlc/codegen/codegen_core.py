...
class CodegenCore:
    ...
    def emit_used_helpers(self) -> None:
        ...
        emitters = {'fn_int_to_dec': getattr(self, 'emit_int_to_dec_function', None),
            ...
            'fn_thread_logical_id': getattr(self, 'emit_thread_logical_id_function', None),
            'fn_thread_set_logical_id': getattr(self, 'emit_thread_set_logical_id_function', None),
            'fn_thread_current_logical_id': getattr(self, 'emit_thread_current_logical_id_function', None),
            'fn_thread_result': getattr(self, 'emit_thread_result_function', None),
            ...
            'fn_bytes_endswith': getattr(self, 'emit_bytes_endswith_function', None),
            'fn_bytes_indexof': getattr(self, 'emit_bytes_indexof_function', None),
            'fn_bytes_lastindexof': getattr(self, 'emit_bytes_lastindexof_function', None),
            'fn_bytes_compare': getattr(self, 'emit_bytes_compare_function', None),
            ...
            'fn_string_slice': getattr(self, 'emit_string_slice_function', None),
            'fn_string_indexof': getattr(self, 'emit_string_indexof_function', None),
            'fn_string_lastindexof': getattr(self, 'emit_string_lastindexof_function', None),
            'fn_string_startswith': getattr(self, 'emit_string_startswith_function', None),
            'fn_string_endswith': getattr(self, 'emit_string_endswith_function', None),
            'fn_string_repeat': getattr(self, 'emit_string_repeat_function', None),
            'fn_string_ltrim_ascii': getattr(self, 'emit_string_ltrim_ascii_function', None),
            'fn_string_rtrim_ascii': getattr(self, 'emit_string_rtrim_ascii_function', None),
            'fn_string_trim_ascii': getattr(self, 'emit_string_trim_ascii_function', None),
            'fn_string_is_blank_ascii': getattr(self, 'emit_string_is_blank_ascii_function', None),
            'fn_string_reverse': getattr(self, 'emit_string_reverse_function', None),
            'fn_string_to_lower_ascii': getattr(self, 'emit_string_to_lower_ascii_function', None),
            'fn_string_to_upper_ascii': getattr(self, 'emit_string_to_upper_ascii_function', None),
            'fn_string_eq_ignore_case_ascii': getattr(self, 'emit_string_eq_ignore_case_ascii_function', None),
            'fn_string_join': getattr(self, 'emit_string_join_function', None),
